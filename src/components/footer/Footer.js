...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaGithub, FaSkype } from "react-icons/fa";
import { logo } from "../../assets/index";

const Footer = () => {
  return (
    <div className="w-full py-20 h-auto border-b-[1px] border-b-black grid grid-cols-1 md:grid-cols-2 lgl:grid-cols-2 justify-between">
      <div className="w-full h-full flex flex-col gap-8 items-center">
        ...
        <div className="flex gap-4">
          ...
          <a
            href="https://github.com/nihuGit?tab=repositories"
            target="_blank"
          ...
          <a
            href="skype:live:.cid.ae7477c767d8b20b?chat"
            target="_blank"
            className="bannerIcon"
          >
            <FaSkype />
